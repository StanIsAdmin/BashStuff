...
GHBU_ORG=${GHBU_ORG-"StanIsAdmin"}                                   # the GitHub organization whose repos will be backed up
                                                                     # (if you're backing up a user's repos instead, this should be your GitHub username)
GHBU_UNAME=${GHBU_UNAME-"StanIsAdmin"}                               # the username of a GitHub account (to use with the GitHub API)		
read -p "Password: " GHBU_PASSWD									 # the password for that account 
